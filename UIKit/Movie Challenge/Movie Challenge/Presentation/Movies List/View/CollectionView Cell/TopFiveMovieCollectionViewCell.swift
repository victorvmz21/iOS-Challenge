//
//  TopFiveMovieCollectionViewCell.swift
//  Movie Challenge
//
...
class TopFiveMovieCollectionViewCell: UICollectionViewCell {
...
extension TopFiveMovieCollectionViewCell: ViewSetupProtocol {
    ...
    func fillCellWith(movie: TopMoviesQueryQuery.Data.Movie?) {
